...
<?php include get_template_directory()."/inc/inc/tabs/Profile-Full-Payment-Methods.php"; ?>
...
<?php if ( WC()->payment_gateways->get_available_payment_gateways() ) : ?>
	...
	<a class="button" href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address' ) ).'billing'; ?>">
        <?php esc_html_e( 'Add/edit billing address', 'woocommerce' ); ?>
    </a>
<?php endif; ?>
